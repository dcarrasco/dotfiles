...
alias pdcbuild='podman-compose build --force-rm --pull'
alias pdps='podman ps --all --format "table {{.ID}}\t{{.Names}}\t{{.Image}}\t{{.Ports}}\t{{.Command}}\t{{.CreatedHuman}}\t{{.Status}}"'
alias pdtop='podman stats --all --format "table {{.Container}}\t{{.Name}}\t{{.CPUPerc}}   {{.MemUsage}}\t{{.NetIO}}\t{{.BlockIO}}\t{{.PIDs}}"'
alias dc='podman-compose "$@"'
alias dcu='podman-compose up -d'
alias dcd='podman-compose down'
alias dcbuild='podman-compose build --force-rm --pull'
alias dps='podman ps --all --format "table {{.ID}}\t{{.Names}}\t{{.Image}}\t{{.Ports}}\t{{.Command}}\t{{.CreatedHuman}}\t{{.Status}}"'
