...
hl.bind("XF86AudioLowerVolume", hl.dsp.exec_cmd(hypr_scripts .. "hypr-set-volume down"), { description = "Decrease volume" })
hl.bind("XF86AudioRaiseVolume", hl.dsp.exec_cmd(hypr_scripts .. "hypr-set-volume up"), { description = "Increase volume" })
